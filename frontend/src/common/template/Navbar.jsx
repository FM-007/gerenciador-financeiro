                ...
                <ul className="nav navbar-nav">
                    ...
                    <li onMouseLeave={() => this.changeOpen()} className={`dropdown user user-menu ${this.state.open ? 'open' : ''}`}>
                        ...
                        <a href="javascript:;" onClick={() => this.changeOpen()} aria-expanded={this.state.open ? 'true' : 'false'} className="dropdown-toggle" data-toggle="dropdown" >
                            ...
                            <img src="https://i.pinimg.com/564x/50/93/3b/50933b3d277a46befc38b321b979a04f.jpg" className="user-image" alt="User Image" />
                        ...
                        <ul className="dropdown-menu">
                            ...
                            <li className="user-header">
                                ...
                                <img src="https://i.pinimg.com/564x/50/93/3b/50933b3d277a46befc38b321b979a04f.jpg" className="img-circle" alt="User Image" />
